...
public class SIAM {
        ...
        if (nimTerinput) {
            ...
            if (nimTerinput && !semTerinput) {
                ...
                for (int i = 0; i < MAX_MK; i++) {
                    System.out.printf(
                        "   Masukkan kode mata kuliah ke-%d\t: ",
                        i + 1
                    );
                    kodeMatkul[indeksMhs][indeksSem][i] = IN.nextLine();
                    System.out.printf(
                        "   Masukkan nama mata kuliah ke-%d\t: ",
                        i + 1
                    );
                    matkul[indeksMhs][indeksSem][i] = IN.nextLine();
                    System.out.printf(
                        "   Masukkan SKS mata kuliah ke-%d\t: ",
                        i + 1
                    );
    ...
    static void editDataKRS() {
        ...
        if (nimTerinput) {
            ...
            if (nimTerinput && semTerinput) {
                ...
                System.out.print(
                    "Masukkan kode mata kuliah yang ingin diubah\t: "
                );
                kodeMK = IN.next();
                IN.nextLine();
                ...
                if (
                    ...
                    System.out.println(
                        "periksa kembali kode mata kuliah yang diinput"
                    );
                    footer_bold();
                ...
                if (nimTerinput && semTerinput && kodeMKTerinput) {
                    ...
                    System.out.printf(
                        "   Masukkan kode mata kuliah yang baru\t: "
                    );
                    kodeMatkul[indeksMhs][indeksSem][indeksKodeMK] =
                        IN.nextLine();
                    System.out.printf(
                        "   Masukkan nama mata kuliah yang baru\t: "
                    );
                    matkul[indeksMhs][indeksSem][indeksKodeMK] = IN.nextLine();
                    System.out.printf(
                        "   Masukkan SKS mata kuliah yang baru\t: "
                    );
        ...
        if (nimTerinput) {
            ...
            if (semTerinput) {
                ...
                if (nilaiAngka[indeksMhs][indeksSem][0] != 0) {
                    ...
                    System.out.println(
                        "tindakan ini dapat menyebabkan overwrite"
                    );
    ...
    static void editNilaiAngka() {
        ...
        if (nimTerinput) {
            ...
            if (nilaiAngka[indeksMhs][indeksSem][0] == 0) {
                ...
                System.out.println(
                    "Saran: Pilih [2] pada menu dan input data KRS"
                );
                footer_bold();
                semTerinput = false;
            } else {
            ...
            if (semTerinput) {
                System.out.println(
                    "Masukkan kode mata kuliah yang ingin diubah nilainya: "
                );
                kodeMK = IN.next();
                ...
                if (nimTerinput && semTerinput && MKTerinput) {
                    ...
                    System.out.printf(
                        "   Masukkan nilai mata kuliah %s yang baru: ",
    ...
    static boolean cekNIMTerinput(String nimMhs) {
        ...
        if (indeksMahasiswa(nimMhs) == MAX_MHS) {
            ...
            System.out.println(
                "Saran: Pilih [1] pada menu dan input data mahasiswa"
            );
            footer_bold();
            terinput = false;
        }
    ...
    static String konversiNilaiKeHuruf(float nilai) {
        ...
        if (nilai > 3.49f) return "A"; else if (
            nilai > 2.99f
        ) return "B+"; else if (nilai > 2.49f) return "B"; else if (
            nilai > 1.99f
        ) return "C"; else if (nilai > 1.49f) return "D"; else return "E";
    }
    ...
    static float ip(byte indeksMhs, byte sem) {
        ...
        for (int i = 0; i < MAX_MK; i++) {
            nilaiMKTotal +=
                nilaiAngka[indeksMhs][sem][i] * sks[indeksMhs][sem][i];
        }
    ...
    static byte maksSKS(float ip) {
        ...
        if (ip >= 3f) return 24; else if (ip >= 2.5f) return 21; else if (
            ip >= 2f
        ) return 18; else if (ip >= 1.5f) return 15; else return 12;
    }
            ...
            if (nimTerinput && semTerinput) {
                ...
                for (int i = 0; i < MAX_MK; i++) {
                    System.out.printf(
                        "%-5s %-18s %-43s %-7s %s\n",
                        i + 1,
                        kodeMatkul[indeksMhs][indeksSem][i],
                        matkul[indeksMhs][indeksSem][i],
                        " ",
                        sks[indeksMhs][indeksSem][i]
                    );
                }
                System.out.println(
                    "--------------------------------------------------------------------------------"
    ...
    static void cetakKHS() {
        ...
        if (nimTerinput) {
            ...
            if (nilaiAngka[indeksMhs][indeksSem][0] == 0) {
                ...
                System.out.println(
                    "Saran: Pilih [4] pada menu dan input nilai mata kuliah"
                );
                footer_bold();
                semTerinput = false;
            } else {
                ...
                for (int i = 0; i < MAX_MK; i++) {
                    System.out.printf(
                        ...
                        konversiNilaiKeHuruf(
                            nilaiAngka[indeksMhs][indeksSem][i]
                        )
                    );
                }
                System.out.println(
    ...
    static void header_ofProgram() {
        ...
        System.out.println(
            "                    APLIKASI KRS/KHS MAHASISWA FILKOM UB                        "
        );
        System.out.println(
            "================================================================================"
        );
    ...
    static void footer_ofProgram() {
        ...
        System.out.println(
            "                   Copyright © 2021 Praktikum Pemdas SI-B                       "
        );
        System.out.println(
            "================================================================================"
        );
